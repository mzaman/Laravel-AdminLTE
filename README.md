...
2. Add the service provider to the `providers` in `config/app.php`:
    ...
    ```php
    MasudZaman\LaravelAdminLte\ServiceProvider::class,
    ```
...
2. Then, publish the public assets with the `--force` flag to overwrite existing files
    ...
    ```
    php artisan vendor:publish --provider="MasudZaman\LaravelAdminLte\ServiceProvider" --tag=assets --force
    ```
...
use MasudZaman\LaravelAdminLte\Menu\Filters\FilterInterface;
use Laratrust;
...
```php
'filters' => [
    MasudZaman\LaravelAdminLte\Menu\Filters\ActiveFilter::class,
    MasudZaman\LaravelAdminLte\Menu\Filters\HrefFilter::class,
    MasudZaman\LaravelAdminLte\Menu\Filters\SubmenuFilter::class,
    MasudZaman\LaravelAdminLte\Menu\Filters\ClassesFilter::class,
    MasudZaman\LaravelAdminLte\Menu\Filters\GateFilter::class, // Comment this line out if you want
